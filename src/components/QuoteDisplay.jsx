      ...
      <div className="relative bg-white/20 dark:bg-gray-900/30 backdrop-blur-3xl rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl border border-white/30 dark:border-gray-700/30 hover:bg-white/25 dark:hover:bg-gray-900/40 transition-all duration-500">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <span className="text-white/80 dark:text-gray-300/80 font-medium text-lg">
              Ilhomli Iqtibos
            </span>
          </div>
          ...
          <motion.button
            ...
            className="group p-3 rounded-xl bg-white/10 dark:bg-gray-800/20 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 hover:bg-white/20 dark:hover:bg-gray-700/30 transition-all duration-300"
        ...
        >
          ...
          {settings.showAuthor && (
            ...
            >
              ...
              <div className="px-6 py-3 bg-white/15 dark:bg-gray-800/25 rounded-full backdrop-blur-sm border border-white/25 dark:border-gray-700/25">
                <p className="text-white/90 dark:text-gray-300/90 text-lg md:text-xl font-medium drop-shadow-lg">
                  {quote.author}
                </p>
              </div>
              <div className="h-px bg-gradient-to-r from-transparent via-white/50 dark:via-gray-300/50 to-transparent w-16"></div>
        ...
        >
          ...
          {quote.tags?.map((tag, index) => (
            <span
              key={index}
              className="px-3 py-1 bg-white/10 dark:bg-gray-800/20 rounded-full text-white/70 dark:text-gray-300/70 text-sm backdrop-blur-sm border border-white/20 dark:border-gray-700/20"
            >
              {tag}
            </span>
          ))}
